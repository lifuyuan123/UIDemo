...
public class CommonDialog extends Dialog {
     ...
     private void init(Context context) {
         setCancelable(true);//点击外部是否隐藏  ture隐藏   false不隐藏
         finView(context); 
         myMeaSure(context); 
         setListener(); 
     } 
     ...
     public void setCancleVisible(int visible){
         switch (visible){
             case View.VISIBLE:
                 comment_dialog_layout.setVisibility(View.VISIBLE);
                 break;
             case View.INVISIBLE:
                 comment_dialog_layout.setVisibility(View.INVISIBLE);
                 break;
             case View.GONE:
